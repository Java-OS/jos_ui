...
class DirectoryTree extends StatefulWidget {
  ...
  @override
  State<DirectoryTree> createState() => _DirectoryTreePageState();
}

class _DirectoryTreePageState extends State<DirectoryTree> {
  ...
  @override
  void initState() {
    if (_filesystemController.filesystemTree.value == null) WidgetsBinding.instance.addPostFrameCallback((_) => Get.back());
    super.initState();
  }
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  spacing: 4,
                  children: [
                    if (_filesystemController.directoryPath.isNotEmpty)
                      KeyValue(
                        k: 'Volume',
                        v: _filesystemController.directoryPath.split('/')[6],
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                ...
                                return FileView(
                                  contextMenuItems: [
                                    ...
                                    ListTile(title: Text('Compress to zip', style: TextStyle(fontSize: 14)), leading: Icon(Icons.archive, size: 18), onTap: () => {Get.back(),compressDialog()}),
